  ...
  <div class="message">
    ...
    <div>
      <p class="welc">
        ...
        Welcome to Mostapha's Website" <br />
        <br />

        Web Developer/CS student
      </p>

      <img class="image" src="../images/ME/mz.png" alt="gggg" />
    </div>
    <div style="margin-top: 330px; margin-left: 470px">
      <a href="../Pages/cv.php"><button class="button">View CV</button></a>
      <div
        style="
          margin-top: 230px;
          margin-left: 200px;
        ...
        <p style="font-family: cursive; font-size: 18px">
          "This is the homepage of my personal website. It introduces me to the
          site visitors and whoever intrested in checking my profile for hiring
          purposes"
        </p>
      </div>
    </div>
