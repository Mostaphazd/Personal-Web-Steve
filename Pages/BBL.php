  ...
  <div class="message">
    ...
    <div class="thumbnails">
        <?php foreach ($images as $image) : ?>
            <a href="../images/BBLprj/<?php echo $image; ?>" onclick="showOverlay(this); return false;">
                <img src="../images/BBLprj/<?php echo str_replace("Thumb", "", $image); ?>" alt="Thumbnail"/>
            </a>
        <?php endforeach; ?>
    </div>
    <div class="gallery-overlay">
        <div class="back-button">
            <a href="../Pages/BBL.php">Back</a>
        </div>
        <img src="" alt="Image"/>
    </div>
</div>

<h3>Please click beside to open the pdf of the project: <a href="../Projects/BBL.pdf" class="see">
    <i></i>SEE PROJECT PDF
</a></h3>
